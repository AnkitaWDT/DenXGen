                                            ...
                                            <TouchableWithoutFeedback>
                                                <ScrollView style={styles.modalContent}>
                                                    ...
                                                    <View style={styles.inputContainerWithLabel}>
                                                        <Text style={[commonStyles.headerText3BL, { marginBottom: 8, }]}>
                                                    ...
                                                    <View style={styles.inputRow}>
                                                        <View style={[styles.inputContainer, {}]}>
                                                            <Text style={[commonStyles.headerText3BL, { marginBottom: 8, }]}>State</Text>
                                                        ...
                                                        <View style={[styles.inputContainer, {}]}>
                                                            <Text style={[commonStyles.headerText3BL, { marginBottom: 8, }]}>Pincode</Text>
                                                            <View style={[styles.inputContainer1, { width: width * 0.43 }]}>
                                                                <TextInput
                                                                    style={[styles.inputs, { textAlign: 'left' }]}
                                                                    placeholder="Pincode"
...
const styles = StyleSheet.create({
    ...
    textContainer: {
        marginLeft: 25, // Adjust the margin as needed
        marginTop: 5,
    },
    modalContainer: {
        flex: 1,
