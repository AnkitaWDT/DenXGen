...
const OfficeProfileCompletion3 = ({ navigation, route }) => {
    ...
    const handleNext = async () => {
        ...
        navigation.navigate('OfficeProfileCompletion4', { off_id: off_id });
...
export default OfficeProfileCompletion3;
