...
const EOfficeProfileCompletion5 = ({ navigation, route }) => {
    ...
    useEffect(() => {
        const fetchTreatmentData = async () => {
            try {
                const response = await axios.get(`https://temp.wedeveloptech.in/denxgen/appdata/getofftreatmentlist-ax.php`);
    ...
    useEffect(() => {
        const fetchServiceData = async () => {
            try {
                const response = await axios.get(`https://temp.wedeveloptech.in/denxgen/appdata/getoffservicelist-ax.php`);
                const data = response.data;
                console.log("Fetched data:", data); // Log fetched data
    ...
    const handleNext = async () => {
        ...
        try {
            const response = await axios.post(`https://temp.wedeveloptech.in/denxgen/appdata/reqofficedtls3-ax.php`, userData);
...
export default EOfficeProfileCompletion5;
