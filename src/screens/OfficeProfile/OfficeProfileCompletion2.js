...
const OfficeProfileCompletion2 = ({ navigation }) => {
...
{/* 
                            ...
                            <View style={styles.inputContainerWithLabel}>
                                <Text style={[commonStyles.headerText4BL, { marginBottom: moderateScale(8), }]}>
                                    Timings <Text style={styles.requiredIndicator}>*</Text>
                                </Text>
                                <View style={styles.inputContainer1}>
                                    <TextInput
                                        style={styles.inputs}
                        ...
                        onPress={() => {
                            navigation.navigate('OfficeProfileCompletion3');
