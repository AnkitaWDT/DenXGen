...
const OfficeProfileCompletion4 = ({ navigation, route }) => {
    ...
    const fetchSavedLocations = async () => {
        try {
            ...
            // if (!off_id) {
            //     console.error('off_id not found in AsyncStorage');
            //     return;
            // }
            // const id1 = parseInt(off_id);

            // Fetch personal details using pr_id
            const response = await axios.get(`https://temp.wedeveloptech.in/denxgen/appdata/getofficelocation-ax.php?off_id=${off_id}`);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post(`https://temp.wedeveloptech.in/denxgen/appdata/reqofficelocation-ax.php`, formData);
    ...
    const handleUpdate = async () => {
        ...
        try {
            const response = await axios.post(`https://temp.wedeveloptech.in/denxgen/appdata/requpdateofficelocation-ax.php?id=`, updateData);
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            navigation.navigate('OfficeProfileCompletion5', { off_id: off_id });
...
export default OfficeProfileCompletion4;
