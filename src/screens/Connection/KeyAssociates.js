...
const KeyAssociates = ({ navigation }) => {
    ...
    const fetchProfessionalsData = async () => {
        try {
            ...
            //https://temp.wedeveloptech.in/denxgen/appdata/getmyacckeyasslist-ax.php?accid=5&accidty=1&action=professionals 

            const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getmyacckeyasslist-ax.php?accid=${accidtyid}&accidty=${accidty}&action=professionals`);
    ...
    const fetchClinicsData = async () => {
        try {
            ...
            const accidty = await AsyncStorage.getItem('selected_profile_accidty');
            const accidtyid = await AsyncStorage.getItem('selected_id');
            const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getmyacckeyasslist-ax.php?accid=${accidtyid}&accidty=${accidty}&action=clinics`);
            //https://temp.wedeveloptech.in/denxgen/appdata/getaccconnlist-ax.php?accid=5&accidty=1&action=professionals 
            //const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getpersmyconnlist-ax.php?pr_id=${id}`);
            const data = await response.json();
    ...
    const fetchOfficesData = async () => {
        try {
            ...
            const accidty = await AsyncStorage.getItem('selected_profile_accidty');
            const accidtyid = await AsyncStorage.getItem('selected_id');
            const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getmyacckeyasslist-ax.php?accid=${accidtyid}&accidty=${accidty}&action=offices`);
            //https://temp.wedeveloptech.in/denxgen/appdata/getaccconnlist-ax.php?accid=5&accidty=1&action=professionals 
            //const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getpersmyconnlist-ax.php?pr_id=${id}`);
            const data = await response.json();
    ...
    const fetchOthersData = async () => {
        try {
            ...
            const accidty = await AsyncStorage.getItem('selected_profile_accidty');
            const accidtyid = await AsyncStorage.getItem('selected_id');
            const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getmyacckeyasslist-ax.php?accid=${accidtyid}&accidty=${accidty}&action=others`);
            //https://temp.wedeveloptech.in/denxgen/appdata/getaccconnlist-ax.php?accid=5&accidty=1&action=professionals 
            //const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getpersmyconnlist-ax.php?pr_id=${id}`);
            const data = await response.json();
    ...
    const cancelConnectionRequest = async () => {
        ...
        const url = `https://temp.wedeveloptech.in/denxgen/appdata/reqdeletepersconn-ax.php?accid1=${accidtyid}&accidty1=${accidtymy}&accid2=${currentId}&accidty2=${currentAccidty}&action=keyassociate`;
        console.log(url);
                                ...
                                <Popover
                                    ...
                                    <View style={commonStyles.popover}>
                                        ...
                                        <AlertPopup
                                            ...
                                            message="Are you sure you want to remove from key associate? "
                                            yesLabel="Yes"
                                            noLabel="No"
                                            onYesPress={() => {
                                                setShowPopup1(false);
            ...
            {isLoading ? (
                ...
                <View>
                    <View style={commonStyles.wrapT}>
                        ...
                        <Text style={commonStyles.backText}>Key Associates</Text>
