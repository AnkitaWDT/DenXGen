...
const MyConnections = ({ navigation }) => {
    ...
    const data = [
        ...
        [
            {
                id: 1, title: 'Ankita Iyer', description: 'Bachelors in Dental Technicians Bachelors in Dental Technicians..', star: '4.8', location: 'Ghatkopar, India',
    ...
    const renderItem = ({ item, index }) => {
        ...
        const truncatedTitle = truncateText(item.title, width * 0.75, 17);
