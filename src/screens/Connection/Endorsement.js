...
const Endorsement = ({ navigation }) => {
    ...
    const fetchSentData = async () => {
        try {
            ...
            const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getmyaccendorsementlist-ax.php?accid=${pr_id}&action=sent`);
    ...
    const fetchReceivedData = async () => {
        try {
            ...
            const accidty = await AsyncStorage.getItem('selected_profile_accidty');
            const accidtyid = await AsyncStorage.getItem('selected_id');
            const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getmyaccendorsementlist-ax.php?accid=${pr_id}&action=received`);
            //https://temp.wedeveloptech.in/denxgen/appdata/getaccconnlist-ax.php?accid=5&accidty=1&action=professionals 
            //const response = await fetch(`https://temp.wedeveloptech.in/denxgen/appdata/getpersmyconnlist-ax.php?pr_id=${id}`);
            const data = await response.json();
    ...
    const cancelConnectionRequest = async () => {
        ...
        const url = `https://temp.wedeveloptech.in/denxgen/appdata/reqdeletepersconn-ax.php?accid1=${accidtyid}&accidty1=${accidtymy}&accid2=${currentId}&accidty2=${currentAccidty}&action=endorsement`;
        console.log(url);
        ...
        try {
            ...
            console.log(`Request cancel successfully for endorsement`);
        } catch (error) {
        ...
        return (
            <ScrollView>
                ...
                <AlertPopup
                    ...
                    message="Are you sure you want to cancel  endorsement request? "
                    yesLabel="Yes"
                    noLabel="No"
                    onYesPress={() => {
                        setShowPopup1(false);
            ...
            {isLoading ? (
                ...
                <View>
                    <View style={commonStyles.wrapT}>
                        ...
                        <Text style={commonStyles.backText}>Endorsement</Text>
