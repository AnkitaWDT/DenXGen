...
const EditClinicProfile = ({ navigation, route }) => {
            ...
            <ScrollView style={styles.subContainer}>
                ...
                <AlertPopup
                    ...
                    onYesPress={() => {
                        ...
                        navigation.navigate('EClinicProfileCompletion1', { cl_id: cl_id });
                    }}
                />
                ...
                <AlertPopup
                    ...
                    onYesPress={() => {
                        setShowPopup1(false);
                        navigation.navigate('EClinicProfileCompletion2', { cl_id: cl_id });
                    }}
                />
                ...
                <AlertPopup
                    ...
                    onYesPress={() => {
                        setShowPopup1(false);
                        navigation.navigate('EClinicProfileCompletion5', { cl_id: cl_id });
                    }}
                />
                ...
                <AlertPopup
                    ...
                    onYesPress={() => {
                        setShowPopup5(false);
                        navigation.navigate('EClinicProfileCompletion3', { cl_id: cl_id });
                    }}
                />
                ...
                <AlertPopup
                    ...
                    onYesPress={() => {
                        setShowPopup6(false);
                        navigation.navigate('EClinicProfileCompletion7', { cl_id: cl_id });
                    }}
                />
