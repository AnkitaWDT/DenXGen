                    ...
                    <View style={{ backgroundColor: '#fff' }}>
                        <View style={{ borderRadius: 10, paddingHorizontal: 20, }}>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Specialities</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Key Forte</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Qualifications</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
                            <View style={{ marginBottom: height * 0.015, }}></View>
                    ...
                    <View style={{ backgroundColor: '#fff' }}>
                        <View style={{ borderRadius: 10, paddingHorizontal: 20, }}>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Educational Qualification</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Working Experience</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
                    ...
                    <View style={{ backgroundColor: '#fff' }}>
                        <View style={{ borderRadius: 10, paddingHorizontal: 20, }}>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Available for Home Visits</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Languages spoken</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
                             <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Experience</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Registration Number</Text>
                                    <Text style={[commonStyles.headerText5G]}>AT573899I</Text>
                                </View>
                            </View>
                            ...
                            <View style={{ flexDirection: 'row', marginTop: 10 }}>
                                ...
                                <View style={{ marginLeft: 10, alignSelf: 'center' }}>
                                    <Text style={[commonStyles.headerText4BL]}>Payments</Text>
                                    <Text style={[commonStyles.headerText5G]}>Add/Edit</Text>
                                </View>
                            </View>
