...
const ManageClinicAddress = ({ navigation, route }) => {
    ...
    const fetchSavedLocations = async () => {
        try {
            ...
            const response = await axios.get(`https://temp.wedeveloptech.in/denxgen/appdata/getcliniclocation-ax.php?cl_id=${cl_id}`);
...
export default ManageClinicAddress
